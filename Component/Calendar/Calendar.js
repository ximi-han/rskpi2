...
//====================================================   参数设定部分   =======================================================   
  ...
  document.writeln('<iframe id="meizzDateLayer" Author="wayx" frameborder="0" width="155" height="211" style="position:absolute;z-index:9998;display:none"></iframe>');   
  strFrame='<style>';   
  strFrame+='INPUT.button{BORDER-RIGHT:#416BB0 1px solid;BORDER-TOP:#416BB0 1px solid;BORDER-LEFT:#416BB0 1px solid;';   
  strFrame+='BORDER-BOTTOM:#416BB0 1px solid;BACKGROUND-COLOR:#fff8ec;font-family:宋体;}';   
  ...
  strFrame+='</scr'   +   'ipt>';   
  strFrame+='<div style="z-index:9999;position:absolute;left:0;top:0;width:100%;height:100%;" onselectstart="return false"><span id=tmpSelectYearLayer Author=wayx style="z-index:9999;position:absolute;top:3;left:19;display:none"></span>';   
  strFrame+='<span id=tmpSelectMonthLayer Author=wayx style="z-index:9999;position:absolute;top:3;left:78;display:none"></span>';   
  strFrame+='<table   border=1   cellspacing=0   cellpadding=0   width=100%   height=160   bordercolor=#416BB0   bgcolor=#416BB0   Author="wayx">';   
  strFrame+='     <tr   Author="wayx"><td   width=100%   height=23   Author="wayx"   bgcolor=#FFFFFF><table   border=0   cellspacing=1   cellpadding=0   width=100%   Author="wayx"   height=23>';   
  strFrame+='             <tr   align=center   Author="wayx"><td   width=16   align=center   bgcolor=#416BB0   style="font-size:12px;cursor:   hand;color:   #ffffff"   ';   
  strFrame+='                 onclick="parent.meizzPrevM()"   title="向前翻   1   月"   Author=meizz><b   Author=meizz>&lt;</b>';   
  strFrame+='                 </td><td   width=60   align=center   style="font-size:12px;cursor:default"   Author=meizz   ';   
  strFrame+='onmouseover="style.backgroundColor=\'#FFF089\'"   onmouseout="style.backgroundColor=\'white\'"   ';   
  ...
  strFrame+='<td   width=48  align=center   style="font-size:12px;cursor:default"   Author=meizz   onmouseover="style.backgroundColor=\'#FFF089\'"   ';   
  ...
  strFrame+='                 <td   width=16   bgcolor=#416BB0   align=center   style="font-size:12px;cursor:   hand;color:   #ffffff"   ';   
  ...
  strFrame+='<table   border=1   cellspacing=0   cellpadding=0   bgcolor=#416BB0   '   +   (bMoveable?   'onmousedown="DragStart()"   onmouseup="DragEnd()"':'');   
  strFrame+='   BORDERCOLORLIGHT=#416BB0   BORDERCOLORDARK=#FFFFFF   width=100%   height=20   Author="wayx"   style="cursor:'   +   (bMoveable   ?   'move':'default')   +   '">';   
  ...
  strFrame+='         <table   border=1   cellspacing=2   cellpadding=0   BORDERCOLORLIGHT=#416BB0   BORDERCOLORDARK=#FFFFFF   bgcolor=#fff8ec   width=100%   height=120   Author="wayx">';   
...
function   GetDOW(day,month,year)           //求某天的星期几   
  ...
  var   today;   
        ...
        if   (meizzTheMonth   <   10){meizzTheMonth   =   "0"   +   meizzTheMonth;}   
           if   (outObject)   
           {   
          if   (!today)   {//outObject.value="";     
              return;}   
          if   (   today   <   10){today   =   "0"   +   today;}   
          outObject.value=   meizzTheYear   +   "-"   +   meizzTheMonth   +   "-"   +   today   ;   //注：在这里你可以输出改成你想要的格式   
          closeLayer();     
      }   
  ...
  meizzWDay[i]   ==   new   Date().getDate())   ?   "#FFF089":"#e0e0e0");   
  //将选中的日期显示为凹下去   
  if((mm==1?yy-1:yy)==outDate.getFullYear()   &&   (mm==1?12:mm-1)==   outDate.getMonth()   +   1   &&     
  meizzWDay[i]==outDate.getDate())   
  {   
  da.borderColorLight="#FFFFFF";   
  da.borderColorDark="#416BB0";   
  }   
  }   
  }   
