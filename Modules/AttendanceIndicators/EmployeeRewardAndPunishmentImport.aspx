<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPageDefault.master" CodeFile="EmployeeRewardAndPunishmentImport.aspx.cs" Inherits="Modules_AttendanceIndicators_EmployeeRewardAndPunishmentImport" %>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td colspan="10"></td>
                            <td>
                                <asp:Button ID="Button1" runat="server" Text="獎懲導入" Height="20px" Width="100px" />
                            </td>
                            <td colspan="10"></td>
                            <td>
